...
data class CoinMarketCapCoin(
        ...
        @Column
        @SerializedName(value="price_eur",alternate = arrayOf(
                "price_aud",
                "price_brl",
                "price_cad",
                "price_chf",
        ...
        @Column
        @SerializedName(value="24h_volume_eur",alternate = arrayOf(
                "24h_volume_aud",
                "24h_volume_brl",
                "24h_volume_cad",
                "24h_volume_chf",
        ...
        @Column
        @SerializedName(value="market_cap_eur",alternate = arrayOf(
                "market_cap_aud",
                "market_cap_brl",
                "market_cap_cad",
                "market_cap_chf",
